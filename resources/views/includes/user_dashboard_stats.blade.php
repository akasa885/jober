<ul class="row profilestat">
          ...
          <li class="col-md-2 col-sm-4 col-xs-6">
            <div class="inbox"> <i class="fa fa-envelope" aria-hidden="true"></i>
              <h6><a href="{{route('my.messages')}}">{{Auth::user()->countApplicantMessages()}}</a></h6>
              <strong>{{__('Messages')}}</strong> </div>
          </li>
          <li class="col-md-2 col-sm-4 col-xs-6">
            <div class="inbox"> <i class="fas fa-coins" aria-hidden="true"></i>
              <h6><a href="{{route('company.messages')}}">{{__('15000')}}</a></h6>
              <strong>{{__('Point')}}</strong> </div>
          </li>
</ul>