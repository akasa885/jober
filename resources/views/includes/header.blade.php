            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown userbtn"><a href="#">{{Auth::user()->printUserImage()}}</a>
                <ul class="dropdown-menu">
                  <li><a href="{{route('home')}}"><i class="fas fa-tachometer-alt" aria-hidden="true"></i> {{__('Dashboard')}}</a> </li>
                  ...
                  <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form-header').submit();"><i class="fa fa-sign-out-alt" aria-hidden="true"></i> {{__('Logout')}}</a> </li>
              ...
              <li class="dropdown userbtn"><a href="#">{{Auth::guard('company')->user()->printCompanyImage()}}</a>
                <ul class="dropdown-menu">
                  <li><a href="{{route('company.home')}}"><i class="fas fa-tachometer-alt" aria-hidden="true"></i> {{__('Dashboard')}}</a> </li>
                  ...
                  <li><a href="{{route('company.messages')}}"><i class="far fa-envelope" aria-hidden="true"></i> {{__('Company Messages')}}</a></li>
                  <li><a href="{{ route('company.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form-header1').submit();"><i class="fa fa-sign-out-alt" aria-hidden="true"></i>{{__('Logout')}}</a> </li>
              ...
              <li class="dropdown"><a href="#">{{__('Sign in')}} <span class="caret"></span></a> 
