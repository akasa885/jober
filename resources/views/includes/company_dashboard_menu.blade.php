<div class="col-md-3 col-sm-4">
        <ul class="usernavdash">
          <li class="active"><a href="{{route('company.home')}}"><i class="fas fa-tachometer-alt" aria-hidden="true"></i> {{__('Dashboard')}}</a></li>
          ...
          <li><a href="{{route('company.followers')}}"><i class="far fa-user" aria-hidden="true"></i> {{__('Company Followers')}}</a></li>
          <li><a href="{{ route('company.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out-alt" aria-hidden="true"></i> {{__('Logout')}}</a>
