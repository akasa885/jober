...
//tambahan editing karena image error
...
class ImageUploadingHelper
{
    ...
    public static function UploadImage($destinationPath, $field, $newName = '', $width = 0, $height = 0, $makeOtherSizesImages = true)
    {
        ...
        if ($makeOtherSizesImages === true) {
            ...
            //tambahan editing karena image error
            // File::exists(storage_path($midImagePath . '/' . $fileName)) or 
            // File::makeDirectory(storage_path($midImagePath));
            ...
            //tambahan editing karena image error
            // File::exists(storage_path($thumbImagePath . '/' . $fileName)) or 
            // File::makeDirectory(storage_path($thumbImagePath));
